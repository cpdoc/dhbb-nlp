...
--Sunstituindo a ordena pela própria ordenação da linguagem podemos ganhar tempo de excussão?
...
simplifica l = foldr merge [] $ sort l --Sunstituimos a ordena pelo sort da linguágem (teoricamente otimizado)?
